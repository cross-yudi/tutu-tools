...
(function(){
  var guides = {
    ...
    'rubik-cube':'3D在线魔方模拟器，支持上下左右前后六个面的旋转操作，可打乱和还原，支持鼠标拖拽旋转视角。适用于魔方学习和练习。<br>3D Rubik cube simulator with full 6-face rotation. Scramble, reset, and drag to rotate view.',
...
(function(){
  var relatedMap = {
    ...
    'rubik-cube':[{name:'数字拼图 15-Puzzle',url:'../../tools/puzzle-15/'},{name:'2048数字合并 2048',url:'../../tools/game-2048/'},{name:'舒尔特方格 Schulte Grid',url:'../../tools/schulte-grid/'}],
