...
(function(){
  var guides = {
    ...
    'wooden-fish':'在线电子木鱼，禅意随行一键敲心！点击木鱼或空格键积攒功德，支持自动敲击模式。禅语随机切换，功德持久保存。解压神器。<br>Electronic wooden fish — click or space to knock and accumulate merit. Auto-knock mode included. Zen quotes, merit saved.',
    ...
    'fireworks':'在线烟花小游戏，点击屏幕任意位置绽放绚丽的彩色烟花，支持连续自动燃放模式。粒子特效+拖尾效果，视觉解压。<br>Fireworks display — click anywhere to launch colorful particle fireworks. Auto-fire mode included. Great for stress relief.',
...
(function(){
  var relatedMap = {
    ...
    'fireworks':[{name:'颜色挑战 Color Challenge',url:'../../tools/color-challenge/'},{name:'反应速度测试 Reaction Test',url:'../../tools/reaction-test/'},{name:'接水果 Fruit Catch',url:'../../tools/fruit-catch/'}],
    ...
    'wooden-fish':[{name:'随机语录 Random Quotes',url:'../../tools/random-quotes/'},{name:'秒表 Stopwatch',url:'../../tools/stopwatch/'},{name:'反应速度测试 Reaction Test',url:'../../tools/reaction-test/'}],
